...
import { articlesListPageNumber, articlesListPageHasMore, articlesListLoading, } from '../../selectors/articlesList';
...
export var fetchNextArticlesPage = createAsyncThunk('articlesPage/fetchNextArticlesPage', function (_, thunkApi) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        hasMore = articlesListPageHasMore(getState());
        page = articlesListPageNumber(getState());
        isLoading = articlesListLoading(getState());

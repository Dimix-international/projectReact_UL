...
import { getArticlesListPageInited, } from '../../selectors/articlesList';
...
export var initArticlesPage = createAsyncThunk('articlesPage/initArticlesPage', function (searchParams, thunkApi) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        inited = getArticlesListPageInited(getState());
        if (!inited) {
            ...
            dispatch(articlePageActions.setOrder(orderFromUrl ? orderFromUrl : 'asc'));

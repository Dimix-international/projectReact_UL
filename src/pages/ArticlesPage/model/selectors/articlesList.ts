...
export const getArticlesListPageInited = (state: StateSchema) => state.articlesPage?._inited || false;

export const getArticlesListPageSearch = (state: StateSchema) => state.articlesPage?.search || '';
export const getArticlesListPageOrder = (state: StateSchema) => state.articlesPage?.order || 'asc';
export const getArticlesListPageSort = (state: StateSchema) => state.articlesPage?.sort || ArticleSortField.CREATED;
export const getArticlesListPageType = (state: StateSchema) => state.articlesPage?.type || ArticleType.IT;
